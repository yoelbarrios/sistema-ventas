    ...
    >
      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          <div class="container flex justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
            ...
            <!-- start options de la derecha de la barra de busqueda -->
              ...
              <li class="relative">
                ...
                >
                  <img
                    ...
                    src="{{asset('storage/img/usuario/'.Auth::user()->imagen)}}"
                    alt=""
                    aria-hidden="true"
                  />
                </button>
            ...
            <!-- end options de la derecha de la barra de busqueda -->
          </div>
        </header>
        <!--end barra header-->
